...
from onyx.server.features.security_layer.api import router as security_layer_router
...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    ...
    include_router_with_global_prefix_prepended(application, security_layer_router)
